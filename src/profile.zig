...
const words = [_][]const u8{ "apple", "banana", "cherry", "dog", "elephant", "flower", "guitar", "happy", "island", "jungle", "kitchen", "lemon", "mountain", "notebook", "ocean", "pencil", "quiet", "rainbow", "sunset", "tiger", "umbrella", "valley", "window", "xylophone", "yellow", "zebra", "adventure", "bridge", "castle", "dream", "energy", "freedom", "galaxy", "harmony", "journey", "knowledge", "lantern", "mystery", "nature", "opportunity", "passion", "question", "reflection", "serenity", "treasure", "universe", "victory", "wisdom", "explore", "zephyr", "bicycle", "candle", "dragon", "emerald", "feather", "garden", "horizon", "imagine", "jewel", "kindness", "library", "meadow", "nightfall", "orchestra", "painting", "quartz", "river", "starlight", "thunder", "uplift", "voyage", "waterfall", "xenial", "yearning", "zenith", "anchor", "butterfly", "compass", "dolphin", "eclipse", "fountain", "glacier", "hurricane", "infinity", "jasmine", "kaleidoscope", "lighthouse", "moonbeam", "nightingale", "opal", "phoenix", "quicksilver", "radiance", "symphony", "tempest", "utopia", "velvet", "whirlwind", "xanadu", "yonder" };
